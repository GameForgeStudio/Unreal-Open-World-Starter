...
AOWSTestLabPhysicsProp::AOWSTestLabPhysicsProp()
{
...
void AOWSTestLabPhysicsProp::InitializeShowcaseProp(
	UStaticMesh* Mesh,
...
void AOWSTestLabPhysicsProp::GetLifetimeReplicatedProps(
	TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcaseMesh);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcaseMassInKg);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcaseColor);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcaseRoughness);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcasePhysicalFriction);
	DOREPLIFETIME(AOWSTestLabPhysicsProp, ShowcaseRestitution);
}

void AOWSTestLabPhysicsProp::OnRep_ShowcaseConfiguration()
{
	ApplyShowcaseConfiguration();
}

void AOWSTestLabPhysicsProp::ApplyShowcaseConfiguration()
{
	if (ShowcaseMesh)
	{
