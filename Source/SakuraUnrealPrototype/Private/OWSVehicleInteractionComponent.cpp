...
bool UOWSVehicleInteractionComponent::TryEnterVehicle()
{
	...
	USakuraStockVehicleInteractionComponent* Interaction = nullptr;
...
bool UOWSVehicleInteractionComponent::TryExitVehicle()
{
	...
	USakuraStockVehicleInteractionComponent* Interaction = Vehicle
	...
	FName& OutSeatId) const
{
	...
	for (const FOverlapResult& Hit : Hits)
	{
		...
		USakuraStockVehicleInteractionComponent* CandidateInteraction = Candidate
