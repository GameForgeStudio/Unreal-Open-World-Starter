...
#include "SakuraTestLabPhysicsProp.generated.h"
...
class SAKURAUNREALPROTOTYPE_API ASakuraTestLabPhysicsProp final : public AActor
{
	GENERATED_BODY()

public:
	ASakuraTestLabPhysicsProp();
...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sakura|Test Lab|Physics", meta = (AllowPrivateAccess = "true"))
