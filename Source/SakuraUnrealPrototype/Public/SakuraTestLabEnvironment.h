...
#include "SakuraTestLabEnvironment.generated.h"
...
class ASakuraTestLabPhysicsProp;

/**
 * Asset-light, editor-visible geometry for the Sakura integration test lab.
 *
...
class SAKURAUNREALPROTOTYPE_API ASakuraTestLabEnvironment final : public AActor
{
	GENERATED_BODY()

public:
	ASakuraTestLabEnvironment();
...
private:
	ASakuraTestLabPhysicsProp* SpawnPhysicsProp(
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sakura|Test Lab", meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USceneComponent> SceneRoot;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sakura|Test Lab|Geometry", meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sakura|Test Lab|Signs", meta = (AllowPrivateAccess = "true"))
