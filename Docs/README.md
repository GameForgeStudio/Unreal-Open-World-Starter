...
This directory documents the current OWS package, its runtime architecture, and its acceptance standards.
...
2. Current source, assets, and project configuration.
3. `STACK.md` for the documented runtime architecture.
