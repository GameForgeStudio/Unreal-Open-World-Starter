...
struct KINETIFORGE_API FVehicleWheelConfig
{
	...
	/*Unit: cm*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0"))
	float Radius = 33.f;
...
struct KINETIFORGE_API FVehicleTireConfig
{
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", DisplayName = "Global Friction Scale"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", DisplayName = "Relaxation Length"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", ClampMax = "1.0"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", ClampMax = "1.0", DisplayName = "Grip Distribution Bias"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", ClampMax = "1.0", DisplayName = "Accel Affects Turning"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", ClampMax = "1.0", DisplayName = "Turning Affects Accel"))
	float LateralToLongitudinalInterference = 1.f;

	/**
	* Scales the Fx curve output. Determines max longitudinal force.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", DisplayName = "Longitudinal Grip Limit"))
	float MaxFx = 1.f;

	/**
	* Scales the Fy curve output. Determines max cornering force.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (ClampMin = "0.0", DisplayName = "Lateral Grip Limit"))
	float MaxFy = 1.f;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (DisplayName = "Curve: Fx (Longitudinal)"))
	...
	* Note: Slope at origin will be used to determine Optimal Slip.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (DisplayName = "Curve: Fy (Lateral)"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel", meta = (DisplayName = "Curve: Camber To Lateral Drift"))
