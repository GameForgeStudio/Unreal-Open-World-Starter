...
struct KINETIFORGE_API FVehicleSuspensionKinematicsConfig
{
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Suspension", meta = (EditCondition = "SuspensionType != ESuspensionType::StraightLine", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Suspension", meta = (EditCondition = "SuspensionType == ESuspensionType::DoubleWishbone", EditConditionHides))
...
struct KINETIFORGE_API FVehicleSuspensionSpringConfig
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Suspension", meta = (ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0", ToolTip = "Scales the stiffness of the auxiliary spring to prevent ground penetration at full suspension compression."))
...
struct KINETIFORGE_API FVehicleSuspensionSimContext
{
	...
	// [ԭ WheelPos] ����һ������ (1 �� -1)���� Sign/Multiplier ��׼ȷ��Pos ��� Position ����
	float WheelSideSign = 1.f;

	// [ԭ PhysicsDelatTime] �޸���ƴд���� Delat -> Delta
	...
	// [ԭ HubToLowerArmEnd] ��ȷָ�����ǳ����ռ��ƫ������
	FVector3f HubOffsetFromLowerJointChassis = FVector3f(0.f);

	// [ԭ LowerWishboneEnd] ͳһʹ�� BallJoint + ����ϵ
	FVector3f LowerBallJointChassisLocation = FVector3f(0.f);
	...
	// [ԭ TopMountRelativePos]
	FVector3f TopMountChassisLocation = FVector3f(0.f);

	// [ԭ StrutRelativeDirection]
	FVector3f StrutChassisDirection = FVector3f(0.f);

	// [ԭ KinpinRelative] �޸�ƴд Kinpin -> SteerAxis
	FVector3f SteerAxisChassisDirection = FVector3f(0.f);

	// [ԭ RayCastStartRelative]
	FVector3f RayCastStartChassisLocation = FVector3f(0.f);

	// [ԭ ImpactPointWorldVelocity]
	FVector3f ImpactWorldVelocity = FVector3f(0.f);
