...
public:
    ...
    static void DestroyAutoGeneratedComponents(TArray<TWeakObjectPtr<UActorComponent>>& ComponentsToDestroy)
    {
        for (TWeakObjectPtr<UActorComponent> CompPtr : ComponentsToDestroy)
        {
