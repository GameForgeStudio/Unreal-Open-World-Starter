...
#include "SakuraUserSettings.generated.h"

/** Persistent player preferences exposed now for the future settings menu. */
UCLASS(Config = GameUserSettings)
class SAKURACORE_API USakuraUserSettings final : public UGameUserSettings
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintPure, Category = "Sakura|Settings|Vehicles")
	...
	UFUNCTION(BlueprintCallable, Category = "Sakura|Settings|Vehicles")
