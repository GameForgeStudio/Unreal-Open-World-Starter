...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SakuraVehicleSimCurveWheelComponent)

USakuraVehicleSimCurveWheelComponent::USakuraVehicleSimCurveWheelComponent()
{
...
void USakuraVehicleSimCurveWheelComponent::OnOutputReady(
...
Chaos::ISimulationModuleBase* USakuraVehicleSimCurveWheelComponent::CreateNewCoreModule() const
{
