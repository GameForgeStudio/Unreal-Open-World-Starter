...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OWSVehicleSimIgnitionEngineComponent)

namespace OWS::Vehicle::Ignition
{
...
void UOWSVehicleSimIgnitionEngineComponent::OnOutputReady(
...
UOWSVehicleSimIgnitionEngineComponent::CreateNewCoreModule() const
{
	...
	return new OWS::Vehicle::Ignition::FIgnitionEngineSimModule(Settings);
}
