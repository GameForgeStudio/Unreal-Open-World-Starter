...
namespace OWS::Vehicle
{
	 ...
	 */
	OWSVEHICLE_API float StepKinetiThrottle(
		float Current,
		float Target,
		float DeltaTime,
	...
	OWSVEHICLE_API float ApplyKinetiThrottleResponse(
		float SmoothedValue,
	 ...
	 */
	OWSVEHICLE_API void BuildSymmetricLateralSlipSamples(
