...
#include "OWSVehicleOccupancyTypes.generated.h"

class AActor;

/** One data-driven occupant position. SeatType is intentionally open-ended. */
USTRUCT(BlueprintType)
struct OWSVEHICLE_API FOWSVehicleSeatDefinition
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct OWSVEHICLE_API FOWSVehicleDoorDefinition
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct OWSVEHICLE_API FOWSVehicleSeatOccupancy
{
	GENERATED_BODY()
