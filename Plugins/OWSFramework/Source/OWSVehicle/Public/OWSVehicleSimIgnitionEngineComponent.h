...
#include "OWSVehicleSimIgnitionEngineComponent.generated.h"
...
UCLASS(
	...
	meta = (BlueprintSpawnableComponent, DisplayName = "OWS Chaos Ignition Engine"))
class OWSVEHICLE_API UOWSVehicleSimIgnitionEngineComponent
