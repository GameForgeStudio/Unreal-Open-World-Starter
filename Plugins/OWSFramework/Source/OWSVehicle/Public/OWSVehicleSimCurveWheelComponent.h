...
#include "OWSVehicleSimCurveWheelComponent.generated.h"
...
UCLASS(
	...
	meta = (BlueprintSpawnableComponent, DisplayName = "OWS Chaos Curve Wheel"))
class OWSVEHICLE_API UOWSVehicleSimCurveWheelComponent : public UVehicleSimWheelComponent
{
	GENERATED_BODY()

public:
	UOWSVehicleSimCurveWheelComponent();

	/** Leave disabled for an exact stock FWheelSettings baseline. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "OWS|Vehicle|Lateral Slip")
	...
	UPROPERTY(
		EditAnywhere,
		BlueprintReadWrite,
		Category = "OWS|Vehicle|Lateral Slip",
